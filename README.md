...
<img src="./notebooks/images/kg_creation.png" >
...
## Data Access Control - [SHACL-ACL](https://github.com/SDM-TIB/SHACL-ACL)

- SHACL Access Control Lists (SHACL-ACL) is a policy-based access control approach for policies defined in the Shapes Constraint Language (SHACL) 
- [How to run and configure it](https://github.com/SDM-TIB/SHACL-ACL)
...
```
<img src="./notebooks/images/hdi_hci.png"  >
